...
-- This is a generated query. Don't modify it manually, as it'll get overwritten by script
  ...
  hardcoded_stakers AS (
    ...
    -- 5137964 -- epoch 029-60
    -- 5272480 -- epoch 030-61
      query_xxx
  ),  
     ...
     transactionsInvolvingContracts_ethereum as (
       ...
       where
        block_time >= to_timestamp('2025-05-12 12:00:00', 'yyyy-mm-dd hh24:mi:ss')
         and block_time <= to_timestamp('2025-06-09 12:00:00', 'yyyy-mm-dd hh24:mi:ss')         
